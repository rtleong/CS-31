...
int main()
{
	...
	cin >> numberSurveyed;
	cout << "How many of them say they will vote for Gavin? "		// removed a semicolon
	cin >> forGavin;
	...
	cout << endl;
	cout >> pctGavin << "% say they will vote for Gavin." << endl;	// switched the character output arrows
